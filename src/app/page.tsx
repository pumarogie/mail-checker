...
export default function Home() {
  ...
  const filteredResults =
    bulkResults?.results.filter((result) => {
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Supports Excel (.xlsx, .xls, .csv) files. PDF support coming
                    soon.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <div className="text-2xl font-bold text-gray-600">
                  {Math.round(
                    (bulkResults.summary.valid / bulkResults.summary.total) *
                      100,
                  )}
                  %
                </div>
            ...
            {bulkResults.summary.truncated && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-4">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  ⚠️ Results were limited to 100 emails. Some emails from your
